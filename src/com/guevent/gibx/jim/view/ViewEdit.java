...
public class ViewEdit extends JDialog {
	...
	public ViewEdit(){
		setTitle("Family360 - Edit Member");
		...
		pane3.add(btnEdit, "span 2, growx");
		...
		pack();
		setModal(true);
		formRenderer = new FormRenderer(this, "edit");
